...
<title><? echo $_GET['list']."_".$_GET['gro']."_".$_GET['idlo']."~".$_GET['idup'] ?></title>
...
<p class="menu">
  ...
  &nbsp;&nbsp;
  Ip:<? echo $_SERVER["REMOTE_ADDR"];?>;Real Ip:<? include('getip.php'); ?><iframe frameborder="0" height="18px"  scrolling="no" marginheight="0px" src="/H-wordlist/getip.php" >	</iframe>
</p>
...
&nbsp;&nbsp;
<a href="default12.0m.php?list=<? echo $_GET['list'] ?>&amp;gro=<? echo $_GET['gro'] ?>&amp;idlo=<? echo $_GET['idlo'] ?>&amp;idup=<? echo $_GET['idup'] ?>"><button id="xiaomiversion">Xiaomi version(X)</button></a>
&nbsp;&nbsp;
<button id="manconsole" onclick="manconsole('<? echo  $_GET['list'] ?>')">Manual_Console(M)</button>


<!--　<input onclick=document.all.WebBrowser.ExecWB(4,1) type=button value=另存为 name=Button2> -->

<br/>
<iframe frameborder="0" height="18px"  scrolling="no" marginheight="0px" src="/H-wordlist/briefsta.php?list=<? echo $_GET['list'] ?>&amp;idlo=<? echo $_GET['idlo'] ?>&amp;idup=<? echo $_GET['idup'] ?>" id="ifrmstatdefault">	</iframe>
<br/>
