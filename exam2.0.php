...
<input name="submit" type="submit" value="检索" />
	...
	<div class="examdiv" id="exam<? echo $j ?>" width="1024">
	 <table width="1250" border="0" cellspacing="0" cellpadding="0" id="wdtb<? echo $row["id"]; ?>">  
		<tr>
			<td height="200"  colspan="3" align="center" valign="middle" id="wd<? echo $row["id"]; ?>" onclick="lookwd(<? echo $row["id"]; ?>,'<? echo $row["chi"]; ?>','<? echo $row["eng"]; ?>')"  ondblclick="looksound('<? echo $row["eng"]; ?>')"><span id="wdid<? echo $j ?>"><? echo $row["id"]; ?></span>&nbsp;&nbsp;&nbsp;<? echo $row["eng"]; ?></td>
		</tr>
		<tr>
...
<div id="examswitchbar">	
  ...
  <span  class="menu">
	...
	&nbsp;&nbsp;
<a href="exam1.0m.php?list=<? echo $_GET['list'] ?>&amp;gro=<? echo $_GET['gro'] ?>&amp;idlo=<? echo $_GET['idlo'] ?>&amp;idup=<? echo $_GET['idup'] ?>"><button id="xiaomiversion">Xiaomi version(X)</button></a>
<br/>
