...
-->
<?php
include('printimpwdlist.php');
include('printwdlist.php');
...
<script type="text/javascript" src="impwdlist.js"></script>
<script type="text/javascript" src="wdlistall.js"></script>
...
<button onclick="changewdlist()">Changelist</button>
	...
	<div class="examdiv"  width="1024">
	 <table width="1250" border="0" cellspacing="0" cellpadding="0" id="wdtb">  
		...
		<tr>
			<td height="140"  colspan="3" align="center" valign="middle" ><span id="examtdrec"></span><a id="examdict" href="http://dict.cn/" target="_blank"><img src="images/favicon.ico" /></a>&nbsp;<span id="examrecunrimg"></span></td>
		</tr>
		<tr id="exambt">
...
<div id="examswitchbar">	
  ...
  <span  class="menu">
	...
	&nbsp;&nbsp;
	<a href="default.php?list=<? echo $_GET['list'] ?>&amp;gro=<? echo $_GET['gro'] ?>&amp;idlo=<? echo $_GET['idlo'] ?>&amp;idup=<? echo $_GET['idup'] ?>""><button id="backtolist">Back_to_list(B)</button></a>
...
$file=fopen('output/Examoutput.html','w');
fwrite($file,$info);
fclose($file);
?>