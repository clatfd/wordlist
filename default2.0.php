...
$sql="Select * from wordlist where id > 1";
...
function post<? echo $row["id"]; ?>()
{
	$.ajax({url: "Up.php?id=<? echo $row["id"]; ?>" ,success: function (){alert("ok");$("#wdtb<? echo $row['id']; ?>").fadeTo("slow",0.01);}});
}
//function delrun()
//{
...
<td>
 <table width="250" border="0" cellspacing="0" cellpadding="0" id="wdtb<? echo $row["id"]; ?>">  
    ...
    <tr>
    	<td width="50%" height="30" align="center" valign="middle" onclick="post<? echo $row["id"]; ?>()"><img src="images/1.gif" width="52" height="18" border="0" /></td>
        <td width="50%" align="center" valign="middle"><a href="Down.php?id=<? echo $row["id"] ?>"><img src="images/2.gif" width="52" height="18" border="0" /></a></td>
    </tr>
