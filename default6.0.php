...
<br/>
<a class="menu" href="default.php?list=<? echo $_GET['list'] ?>&gr=<? echo $_GET['gr']+1 ?>&idlo=<? echo $_GET['idlo'] ?>&idup=<? echo $_GET['idup'] ?>">next_group </a>
<br/>
<a class="menu" href="default.php?list=<? echo $_GET['list'] ?>&gr=<? echo $_GET['gr']-1 ?>&idlo=<? echo $_GET['idlo'] ?>&idup=<? echo $_GET['idup'] ?>">last_group </a>
<br/>
