...
  
<a href="exam1.0m.php?list=<? echo $_GET['list'] ?>&amp;gro=<? echo $_GET['gro'] ?>&amp;idlo=<? echo $_GET['idlo'] ?>&amp;idup=<? echo $_GET['idup'] ?>"><button id="gotoexam">Go_to_exam(G)</button></a>
&nbsp;&nbsp;
...
&nbsp;&nbsp;
	<a href="default12.0mo.php?list=<? echo $_GET['list'] ?>&amp;gro=<? echo $_GET['gro'] ?>&amp;idlo=<? echo $_GET['idlo'] ?>&amp;idup=<? echo $_GET['idup'] ?>""><button id="outputbutton">Output(O)</button></a>
